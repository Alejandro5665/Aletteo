...
# 📌 **Lista de indicadores a extraer**
#460, 510, 511, 512, 513, 514, 515, 516, 517, 1844, 1845, 1846, 1848, 1849, 1850, 541, 542, 543
indicator_ids = [460, 510, 511, 512, 513, 514, 515, 516, 517, 1844, 1845, 1846, 1848, 1849, 1850, 541, 542, 543]  # Agrega más indicadores si es necesario
...
# 📌 **Diccionario para almacenar los DataFrames de cada indicador**
dataframes = {}
...
for indicator_id in indicator_ids:
    ...
    if response.status_code == 200:
        ...
        extracted_data = []
        for entry in values:
            fecha_utc = entry["datetime_utc"]  # Fecha en UTC con intervalos de 15 min
            valor = entry["value"]
...
if dataframes:
    ...
    for column in final_df.columns[1:]:  # Excluir "Fecha"
